...
module.exports = (client, int) => {
    ...
    switch (int.customId) {
        case 'saveTrack':
            {
                if (!queue || !queue.playing) return int.reply({ content: `Hiện không có bài hát nào đang phát. ❌`, ephemeral: true, components: [] });
        ...
        case 'time':
            {
                ...
                const embed = new Discord.MessageEmbed()
                    ...
                    .setFooter({ text: 'Music Bot - N2DUC', iconURL: int.user.displayAvatarURL({ dynamic: true }) });
